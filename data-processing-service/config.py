...
class Config:
    ...
    KAFKA_CONSUMER_GROUP = os.getenv('KAFKA_CONSUMER_GROUP', 'data-processing-group')
    KAFKA_TOPIC_MESSAGES = os.getenv('KAFKA_TOPIC_MESSAGES', 'social-messages')
    KAFKA_TOPIC_ANALYTICS = os.getenv('KAFKA_TOPIC_ANALYTICS', 'realtime-analytics')
